...
public class DateUtil {
	...
	public static String getConvertMonth(String mon)
	{
		String monEng = "";
		if(mon.equals("01"))		monEng = "Jan";
		else if(mon.equals("02"))	monEng = "Feb";
		else if(mon.equals("03"))	monEng = "Mar";
		else if(mon.equals("04"))	monEng = "Apr";
		else if(mon.equals("05"))	monEng = "May";
		else if(mon.equals("06"))	monEng = "Jun";
		else if(mon.equals("07"))	monEng = "Jul";
		else if(mon.equals("08"))	monEng = "Aug";
		else if(mon.equals("09"))	monEng = "Sep";
		else if(mon.equals("10"))	monEng = "Oct";
		else if(mon.equals("11"))	monEng = "Nov";
		else if(mon.equals("12"))	monEng = "Dec";
		else monEng ="-";
